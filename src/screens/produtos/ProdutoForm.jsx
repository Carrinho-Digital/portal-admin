...
const UnidadeMedidaOptions = () => {
  ...
  return unidades.map((item, key) => (
    <option key={`unit-${item}-${key}`} value={item}>
      {item.toUpperCase()}
    </option>
  ))
}
        ...
        <Row>
          ...
          <Col xl="3" sm="12">
            <Field
              ...
              name="sku"
              label="SKU"
              placeholder="Ex: 79846531321200148"
            />
          </Col>
          <Col xl="6" sm="12">
            <Field
              ...
              onCreate={(name) => {
                ...
                var tags =
                  currentValues && currentValues.tags ? currentValues.tags : []
