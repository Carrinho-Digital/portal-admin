...
import { searchTags, createTag, searchProducts } from '../../store/promocoes/actions';
    ...
    return <Form onSubmit={handleSubmit}>
        <Row>
            <Col xl="3" sm="12" className="d-flex align-self-center">
                <Field component={renderInput} type="checkbox" name="promotionPerPrice" label="Promoção por valor" />
            </Col>
            {!currentValues.promotionPerPrice ? (
                <Col xl="3" sm="12">
                    ...
                    <Col xl="3" sm="12">
                        <Field required component={renderInput} {...getFieldMask("moedaBRL")} type="text" name="discountInPrice" label="R$ de desconto" placeholder="Ex: R$2,00" />
                    </Col>
                )}
        </Row>
        <Row>
            <Col xl="3" sm="12" className="d-flex align-self-center">
                <Field component={renderInput} type="checkbox" name="promotionPerProduct" label="Promoção por produto" />
            </Col>
            <Col xl="6" sm="12">
        ...
        <Row>
            <Col xl="3" sm="12" className="d-flex align-self-center">
                <Field component={renderInput} type="checkbox" name="undefinedTime" label="Tempo indefinido" placeholder="Ex: Não" />
            </Col>
            {!currentValues.undefinedTime && (
                <>
                    <Col xl="3" sm="12">
                        <Field component={renderInput} type="datetime-local" name="startDate" label="Início" placeholder="Ex: 12/12/2020 12:00" />
                    </Col>
                    <Col xl="3" sm="12">
                        <Field component={renderInput} type="datetime-local" name="endDate" label="Final" placeholder="Ex: 12/12/2020 18:00" />
                    </Col>
                </>
            )}
